...
<Text style={{fontSize: 20, marginVertical: 20}}>《用户协议》</Text>

<Text>

《用户服务协议》（以下简称“协议”）及其条款，系您下载、安装及使用“拉丁园软件”（简称：拉丁园）软件（以下简称“本软件”）所订立的、描述您与本软件之间权利义务的协议。{"\n\n"}
...
<Text style={{fontSize: 20, marginVertical: 20}}>《隐私政策》</Text>

<Text>

《用户隐私政策》及其条款，系您下载、安装及使用“拉丁园软件”（简称：拉丁园）软件（以下简称“本软件”）所订立的、描述您与本软件之间权利义务的协议。{"\n\n"}
...
当我们要将信息用于本隐私政策未载明的其他用途，将会事先征求您的同意。{"\n\n"}
...
除法律法规规定外，您有权随时访问和更正您的个人信息，具体包括：您可通过在设置中删除您的个人昵称信息，并且清除做题记录和学习记录。{"\n\n"}
